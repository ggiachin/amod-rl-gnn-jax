...
JAX reimplementation of [Graph Neural Network Reinforcement Learning for Autonomous Mobility-on-Demand Systems](https://arxiv.org/abs/2104.11434)

All files with _jax ending are mine and re-implemented. All other files belong to the [official original implementation](https://github.com/DanieleGammelli/gnn-rl-for-amod/tree/main) 
...
To train an agent, `main_jax.py` accepts the following arguments:
```bash
cplex arguments:
