...
from src.algos.a2c_gnn_jax import A2C
...
# Initialize A2C-GNN
model = A2C(env=env, input_size=21)
...
if not args.test:
    ...
    for i_episode in epochs:
        ...
        if episode_reward >= best_reward:
            ...
            model.save_checkpoint(i_episode, path=f"/home/gabuntu/Documents/Spring 2024/ME 697 - ML/gnn-rl-for-amod-main/saved_files/ckpt/nyc4/")
            best_reward = episode_reward

    fig, ax = plt.subplots()
    ax.plot(model.loss_actor, label="Actor Loss")
    ax.plot(model.loss_critic, label="Critic Loss")
    ...
    model.load_checkpoint(path=f"/home/gabuntu/Documents/Spring 2024/ME 697 - ML/gnn-rl-for-amod-main/saved_files/ckpt/nyc4/")
